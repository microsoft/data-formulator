...
> **来源**：`design-docs/6-path-safety-confined-dir.md`（ConfinedDir 设计）+ `design-docs/issues/002-arbitrary-file-read-audit.md`（安全审计）。
...
- `design-docs/6-path-safety-confined-dir.md` — ConfinedDir 设计与改造清单
