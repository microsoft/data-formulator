...
export const qcExampleSessions: ExampleSession[] = [
  {
    id: "qc-trend-line",
    title: "QC Trend Line",
    description:
      "Monitor QC values against control limits (TARGET, LL, UL, ARUL) over time",
    previewImage: "/qc_trend_line-thumbnail.svg",
    dataFile: "/df_qc_trend_line.json",
  },
  {
    id: "qc-histogram",
    title: "QC Histogram",
    description:
      "Analyze value distribution relative to QC control limits (LL, UL, TARGET)",
    previewImage: "/qc_histogram-thumbnail.svg",
    dataFile: "/df_qc_histogram.json",
  },
  {
    id: "qc-trend-bar",
    title: "QC Trend Bar",
    description:
      "Visualize QC values per date/shift as stacked bars with control limit lines",
    previewImage: "/qc_trend_bar-thumbnail.svg",
    dataFile: "/df_qc_trend_bar.json",
  },
];
      ...
      <Box
        sx={{
          ...
          background: `linear-gradient(135deg, ${alpha(
            ...
            0.1,
          )} 0%, ${alpha(theme.palette.custom.main, 0.1)} 100%)`,
          display: "flex",
          alignItems: "center",
