  ...
  let dataUploadRequestBox = (
    ...
    >
      ...
      >
        ...
        <Typography fontSize={24} sx={{ color: "text.secondary" }}>
          Turn data into insights with AI agents, with the exploration paths you
          choose.
        </Typography>
        <Box
          sx={{
        ...
        >
          ...
          >
            <DataLoadingChatDialog
              buttonElement={
                <>
                  <AutoFixNormalIcon sx={{ mr: 1, verticalAlign: "middle" }} />
                  Messy data
                </>
              }
            />
            <Box
              component="span"
              sx={{ mx: 2, color: "text.disabled", fontSize: "0.8em" }}
            >
              •
            </Box>
            <DatasetSelectionDialog
            ...
            <TableCopyDialogV2
              buttonElement={
                <>
                  <ContentPasteIcon sx={{ mr: 1, verticalAlign: "middle" }} />
                  clipboard
                </>
              }
              disabled={false}
            ...
            <Typography
              ...
              sx={{ mt: 2, width: "100%" }}
            >
              Load structured data from CSV, Excel, JSON, database, or extract
              data from{" "}
              <Tooltip
                title={
                  <Box>
                    Example of a screenshot of data:{" "}
                    <Box
                      component="img"
